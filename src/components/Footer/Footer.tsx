...
export function Footer({ children }: FooterProps) {
    return (
        <>
            <footer className="m-0 h-28 border-t-4 border-tiffany font-thin text-xl font-custom tracking-normal leading-normal flex flex-col items-center justify-around md:flex-row md:items-center px-4">

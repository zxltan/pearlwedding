    ...
    return (
        <>
            <header className="m-0 h-48 border-t-4 border-tiffany font-thin text-xl font-custom tracking-normal leading-normal flex flex-col items-center justify-around md:flex-row md:items-center px-4">
                <h1 className="text-3xl font-extra text-center">{children}</h1>
                <div className="flex flex-col md:mt-0 gap-1">
                    ...
                    <p className="text-base font-bold text-sm text-gray-600 text-center">Номер телефона: +79289002592</p>
                    <p className="text-base font-bold text-sm text-gray-600 text-center">Проспект Победа Революции, 116, Шахты</p>
                </div>
            </header>
        </>
    );
